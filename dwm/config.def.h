...
static const char *printScr[] = { "scrot", "Screenshots/%T.jpeg", NULL};
static const char *logOut[] = { "loginctl", "terminate-user", "viko", NULL };
...
static const Key keys[] = {
  ...
  { MODKEY|ShiftMask,             XK_Escape, spawn,          {.v = logOut } },
  { MODKEY,                       XK_F2,     spawn,          {.v = volumeDown } },
  { MODKEY,                       XK_F2,     spawn,          SHCMD("$HOME/.config/xob/volume.sh") },
  { MODKEY,                       XK_F3,     spawn,          {.v = volumeUp } },
  { MODKEY,                       XK_F3,     spawn,          SHCMD("$HOME/.config/xob/volume.sh") },
  { MODKEY,			  XK_F5,     spawn,	     {.v = brightDown} },
  { MODKEY,			  XK_F5,     spawn,	     SHCMD("$HOME/.config/xob/brighness.sh") },
  { MODKEY,			  XK_F6,     spawn,	     {.v = brightDown} },
  { MODKEY,			  XK_F6,     spawn,	     SHCMD("$HOME/.config/xob/brighness.sh") },
  //MOVEMENT
